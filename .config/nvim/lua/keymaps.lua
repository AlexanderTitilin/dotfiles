...
vim.api.nvim_set_keymap('n', '<Leader>ff', ':Oil<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<Leader>fn', ':Oil ~/.config/nvim/lua<CR>', { noremap = true, silent = true })
